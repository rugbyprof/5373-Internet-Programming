...
<?php
echo "<center><a href={$_SERVER['PHP_SELF']}?offset={$prev}>PREV</a> 
              <a href={$_SERVER['PHP_SELF']}?offset={$next}>NEXT</a></center>";
//print_r($_SERVER);
echo"<form name='limit' method='GET' action='index.php'>\n\n";
echo"<select name='rowcount'>";
for($i=10;$i<=100;$i+=10){
